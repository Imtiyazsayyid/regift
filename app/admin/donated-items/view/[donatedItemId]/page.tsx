    ...
    >
      ...
      <Grid columns={"3"} className="w-full" gapY={"9"} p={"9"}>
        ...
        <Flex direction={"column"} gap="2">
          ...
          <Text className="text-center">{donatedItem?.isPickedUp ? "True" : "False" || "-"} </Text>
        </Flex>

        <Flex direction={"column"} gap="2">
          <Text className="text-sm text-slate-500 text-center">Available</Text>
          <Text className="text-center">{donatedItem?.isAvailable ? "True" : "False" || "-"} </Text>
        </Flex>
